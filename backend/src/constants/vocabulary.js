...
exports.VOCABULARY = {
    ...
    primary_genre: ['Dance', 'Electronic', 'Rock', 'Pop', 'Hip-Hop', 'R&B / Soul', 'Jazz', 'Blues', 'Country', 'Classical', 'Folk', 'Latin', 'Reggae', 'World', 'Soundtrack', 'Ambient', 'Spoken Word', 'Sound Effect'],
    subgenres: {
    ...
    vocals_presence: ['lead', 'backing', 'choir', 'sampled', 'spoken_word', 'ad-libs'], // 'none' excluded for random generation
