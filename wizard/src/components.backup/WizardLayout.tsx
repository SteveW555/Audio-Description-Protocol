        ...
        <div className="min-h-screen bg-gray-50 dark:bg-slate-900 text-gray-900 dark:text-white font-sans p-4 sm:p-6 lg:p-8">
            <div className="max-w-7xl mx-auto">
                <header className="mb-8">
                    ...
                    <p className="mt-2 text-lg text-gray-500 dark:text-slate-400">Create structured, machine-readable audio descriptions step-by-step.</p>
                </header>

                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    <div className="bg-white dark:bg-slate-700/50 rounded-xl shadow-lg p-6 lg:p-8">
                        <h2 className="text-2xl font-bold text-gray-800 dark:text-slate-100 mb-1">Sample Title</h2>
                        <input
                            ref={titleInputRef}
                            autoFocus
                            type="text"
