...
exports.VOCABULARY_MET = exports.TERMS_BY_FREQUENCY = exports.TERM_FREQUENCIES = exports.SUBCATEGORIES = exports.TAXONOMY_BY_ID = exports.TAXONOMY = void 0;
exports.getTerm = getTerm;
exports.getTerms = getTerms;
exports.getTermIds = getTermIds;
exports.getTermsByCategory = getTermsByCategory;
// ============================================================================
 ...
 */
exports.TAXONOMY_BY_ID = new Map(exports.TAXONOMY.map(function (term) { return [term.id, term]; }));
/**
 * Get term metadata by ID (first occurrence if multi-category)
 */
function getTerm(id) {
    return exports.TAXONOMY_BY_ID.get(id);
}
/**
 * Get ALL occurrences of a term across categories
 */
function getTerms(id) {
    return exports.TAXONOMY.filter(function (t) { return t.id === id; });
}
/**
 * Get all term IDs for a category (may include duplicates from multi-category terms)
 */
function getTermIds(category) {
    return exports.TAXONOMY.filter(function (t) { return t.category === category; }).map(function (t) { return t.id; });
}
/**
 * Get all terms for a category
 */
function getTermsByCategory(category) {
    return exports.TAXONOMY.filter(function (t) { return t.category === category; });
}
/**
 ...
 */
exports.TERM_FREQUENCIES = Object.fromEntries(Array.from(new Map(exports.TAXONOMY.map(function (t) { return [t.id, t.frequency]; })).entries()));
/**
 * Terms organized by frequency within each category
 */
exports.TERMS_BY_FREQUENCY = {
