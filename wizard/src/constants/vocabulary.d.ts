...
export declare const TERM_FREQUENCY_GROUPS: {
    ...
    readonly infrequent: readonly ["infrequent"];
    readonly rare: readonly ["rare"];
};
export declare const VOCABULARY: {
    ...
    readonly key: readonly ["C", "C#", "D", "D#", "E", "F", "F#", "G", "G#", "A", "A#", "B"];
    readonly scale: readonly ["major", "minor", "dorian", "phrygian", "lydian", "mixolydian", "locrian", "chromatic", "pentatonic_major", "pentatonic_minor"];
    readonly vocals_presence: readonly ["none", "lead", "backing", "choir", "sampled", "spoken_word", "ad-libs"];
    ...
    readonly general_roles: readonly ["lead", "rhythm", "melody", "harmony", "bass", "percussion", "pad", "atmospheric", "fx", "counter-melody", "ostinato", "fill", "arpeggio", "chordal"];
    ...
    readonly general_descriptors: readonly ["reverberant", "dry", "processed", "present", "distant", "warm", "bright", "dark", "lofi"];
...
export declare const DEFAULT_INSTRUMENT: InstrumentationEntry;
export declare const MOOD_TERMS_BY_FREQUENCY: Record<import("./taxonomy").FrequencyLevel, string[]>;
export declare const ENERGY_TERMS_BY_FREQUENCY: Record<import("./taxonomy").FrequencyLevel, string[]>;
